...
test('handler builds inject edges from import inject mappings', async () => {
  await withGraphContext(async ({ diagnostics, dataMapper, g }) => {
    const providerComponent = {
      hash: 'hash-import-inject-provider',
      name: 'ImportInjectProvider',
      tasks: [
    ...
    const targetComponent = {
      hash: 'hash-import-inject-target',
      name: 'ImportInjectTarget',
      tasks: [
    ...
    const rootComponent = {
      hash: 'hash-import-inject-root',
      name: 'ImportInjectRoot',
      imports: [
        {
          name: 'target',
