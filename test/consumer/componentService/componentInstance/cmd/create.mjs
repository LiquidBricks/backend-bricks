...
import { usesImportInstances } from '../../../../../consumer/componentService/componentInstance/cmd/start/loadData/usesImportInstances.js'
...
test('start publishes start commands for uses_import componentInstances', async () => {
  await withGraphContext(async ({ diagnostics, dataMapper, g }) => {
    ...
    const { usesImportInstanceIds } = await usesImportInstances({
      rootCtx: { g },
